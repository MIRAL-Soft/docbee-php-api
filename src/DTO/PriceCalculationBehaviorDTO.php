...
final class PriceCalculationBehaviorDTO extends AbstractDTO
{
    ...
    public static function fromArray(array $data): static
    {
        return new self(
            ...
            onHoliday: isset($data['onHoliday']) ? self::toBool($data['onHoliday']) : null,
            onWeekDayMo: isset($data['onWeekDayMo']) ? self::toBool($data['onWeekDayMo']) : null,
            onWeekDayTu: isset($data['onWeekDayTu']) ? self::toBool($data['onWeekDayTu']) : null,
            onWeekDayWe: isset($data['onWeekDayWe']) ? self::toBool($data['onWeekDayWe']) : null,
            onWeekDayTh: isset($data['onWeekDayTh']) ? self::toBool($data['onWeekDayTh']) : null,
            onWeekDayFr: isset($data['onWeekDayFr']) ? self::toBool($data['onWeekDayFr']) : null,
            onWeekDaySa: isset($data['onWeekDaySa']) ? self::toBool($data['onWeekDaySa']) : null,
            onWeekDaySu: isset($data['onWeekDaySu']) ? self::toBool($data['onWeekDaySu']) : null,
