...
/**
 * Represents a Docbee AgreementComponent record.
 */
final class AgreementComponentDTO extends AbstractDTO
{
    ...
    public function isInclusive(): ?bool       { return $this->inclusive; }
    public function getServiceType(): ?int     { return $this->serviceType; }
    public function getSla(): ?int             { return $this->sla; }
    public function isWithinWorkingSla(): ?bool { return $this->withinWorkingSla; }
}
