...
final class ProtocolTemplateEntryDTO extends AbstractDTO
{
    ...
    public static function fromArray(array $data): static
    {
        return new self(
            ...
            released: self::toBool($data['released'] ?? null),
            ...
            required: self::toBool($data['required'] ?? null),
            requiredForComponentScript: self::toBool($data['requiredForComponentScript'] ?? null),
            deactivated: self::toBool($data['deactivated'] ?? null),
            ...
            sendMessageToObservers: self::toBool($data['sendMessageToObservers'] ?? null),
            ...
            inputHide: self::toBool($data['inputHide'] ?? null),
