...
final class GroupDTO extends AbstractDTO
{
    ...
    public static function fromArray(array $data): static
    {
        return new self(
            ...
            avoidBreak: self::toBool($data['avoidBreak'] ?? null),
            pdfHide: self::toBool($data['pdfHide'] ?? null),
            isMultiGroup: self::toBool($data['isMultiGroup'] ?? null),
            showMultiGroupAsTable: self::toBool($data['showMultiGroupAsTable'] ?? null),
            ...
            pdfTableLayout: self::toBool($data['pdfTableLayout'] ?? null),
